...
- [`deliverables/breakeven_margins.svg`](../deliverables/breakeven_margins.svg)
  and [`.csv`](../deliverables/breakeven_margins.csv) — a break-even /
  margin-of-safety view of the top-ranked process, showing how far each
  assumption can move before the 3-year case stops paying (generated by
  [`scripts/make_breakeven.py`](../scripts/make_breakeven.py); tolerances on the
  synthetic assumptions, not probabilities).
- [`deliverables/rollout_cashflow.svg`](../deliverables/rollout_cashflow.svg) and
  [`.csv`](../deliverables/rollout_cashflow.csv) — a phased-rollout cumulative
  cashflow view of the top-ranked process: the ramped cashflow curve against the
  idealised full-benefit line, marking when it really turns cash-positive once a
  linear adoption ramp is allowed for. A 6-month ramp pushes invoice-matching
  payback from an idealised 2.8 months to month 6 and costs ~€37,200 of 3-year
  net benefit (generated by [`scripts/make_rollout.py`](../scripts/make_rollout.py);
  the ramp shape is an illustrative assumption, not a measured curve).
